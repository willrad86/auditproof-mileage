...
interface StartOfMonthPhotoModalProps {
  visible: boolean;
  vehicleName: string;
  monthYear: string;
...
export default function StartOfMonthPhotoModal({
  visible,
  vehicleName,
  monthYear,
  onPhotoTaken,
  onDismiss,
}: StartOfMonthPhotoModalProps) {
  ...
  async function handleTakePhoto() {
    try {
      ...
      console.error('Error taking start-of-month photo:', error);
      ...
      <View style={styles.overlay}>
        <View style={styles.content}>
          <View style={styles.header}>
            <Text style={styles.title}>Start-of-Month Verification</Text>
          ...
          <Text style={styles.description}>
            Please take a photo of your odometer to record the starting mileage for {monthYear}.
            This is required for accurate mileage tracking.
          </Text>
          ...
          >
            {taking ? (
              ...
              <>
                ...
                <Text style={styles.buttonText}>Take Starting Photo</Text>
              </>
            )}
          </TouchableOpacity>
